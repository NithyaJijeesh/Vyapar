...
class ItemModel(models.Model):
    ...
    item_hsn = models.PositiveIntegerField(null=True,blank = True)
    item_unit = models.CharField(max_length=255,null=True,blank=True)
    item_taxable = models.CharField(max_length=255,null=True,blank=True)
    item_gst = models.CharField(max_length=255,null=True)
    item_igst = models.CharField(max_length=255,null=True)
    item_sale_price = models.PositiveIntegerField(null=True,blank=True)
    item_purchase_price = models.PositiveBigIntegerField(null=True,blank=True)
    item_opening_stock = models.PositiveBigIntegerField(default=0,null=True,blank=True)
    item_current_stock = models.PositiveBigIntegerField(default=0,null=True,blank=True)
    item_at_price = models.PositiveBigIntegerField(default=0,null=True,blank=True)
    item_date = models.DateField(null=True,blank=True)
    item_min_stock_maintain = models.PositiveBigIntegerField(default=0,null=True,blank=True)
